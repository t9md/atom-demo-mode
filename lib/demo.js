...
module.exports = class Demo {
  ...
  handleMouseDown(event) {
    ...
    const dragOriginLeft = event.clientX - this.state.left
    const dragOriginTop = event.clientY - this.state.top

    const handleMouseMove = event => {
      this.state.left = event.clientX - dragOriginLeft
      this.state.top = event.clientY - dragOriginTop
      this.render()
    }
