...
module.exports = class Demo {
  ...
  moveHover(direction) {
    if (direction === "up") this.offset.top -= 10
    else if (direction === "down") this.offset.top += 10
    else if (direction === "left") this.offset.left -= 10
    else if (direction === "right") this.offset.left += 10
    this.render()
  }
}
